...
export const DrinksPage: FC = () => {
  return (
    <section className="page container flex-col-reverse xl:flex-row flex items-center gap-3 md:gap-5 xl:gap-7">
      <div className="w-full xl:w-2/5 max-w-xl flex flex-col gap-3 md:gap-5 xl:gap-7">
        <div className="flex flex-col gap-1.5">
          {drinksList.slice(0, 6).map((item, idx) => (
            <MotionEl key={item.title} direction="left" delay={idx / 10} className="flex items-center justify-between">
